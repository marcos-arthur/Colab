<%@ Page Title="" Language="C#" MasterPageFile="~/PageMasterServidor.Master" AutoEventWireup="true" CodeBehind="WebFormEditSalas.aspx.cs" Inherits="ProjectColab._2_Servidor.WebFormEditSalas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> <div class="row">
        <div class="column middle">       
            ...
            <!--Repeater para os equipamentos do sala-->
<div class="content">
            <asp:repeater runat="server" ID="salaEquips" DataSourceID="ObjectDataSource2">
                <ItemTemplate>            
                        <div class="article">
            ...
            <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="SelectFromSala" TypeName="ProjectColab.DAL.DALEquipamento">
                <SelectParameters>
