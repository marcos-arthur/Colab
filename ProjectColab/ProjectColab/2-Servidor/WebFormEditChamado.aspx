                    ...
                    <ItemTemplate>
                        <div class="editmenu">
                            ...
                            <div class="rowChamado"><a class="textEditChamado"> Data de abertura </a><a class="textEditChamado nomeChamado"><%# DataBinder.Eval(Container.DataItem, "data")%> </a></div>
                             ...
                             <div class="bot"><asp:LinkButton ID="LinkButton2" runat="server" CssClass="" CommandName="Fechar" CommandArgument='<%#Eval("id")%>'><i class="fa fa-external-link-square"></i> FECHAR CHAMADO</asp:LinkButton>
                    </ItemTemplate>
                </asp:Repeater>
