        ...
        <asp:Button runat="server" ID="Button1" Text="VISUALIZAR CHAMADOS FECHADOS" CssClass="btn" PostBackUrl="~/4-Professor/WebFormChamadosFechadosProfessor.aspx"/>
            ...
            <div class="content">  
                <div class="searchplace">
                        <asp:LinkButton ID="Button3" runat="server" CssClass="btnsearch bg ch" PostBackUrl="~/2-Servidor/WebFormAddChamado.aspx" ><i class=" fa fa-plus"></i> ABRIR CHAMADO</asp:LinkButton>                                           
